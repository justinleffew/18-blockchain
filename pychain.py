...
# YOUR CODE HERE
a = st.text_input("sender")
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
b = st.text_input("receiver")
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
c = st.text_input("amount")
...
if st.button("Add Block"):
 ...
 ###Stuck on how to get sender, receiver, and amount values added to the new block
